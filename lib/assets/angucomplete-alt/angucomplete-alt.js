...
(function (root, factory) {
  ...
  angular.module('angucomplete-alt', []).directive('angucompleteAlt', ['$q', '$parse', '$http', '$sce', '$timeout', '$templateCache', '$interpolate', function ($q, $parse, $http, $sce, $timeout, $templateCache, $interpolate) {
    ...
    $templateCache.put(TEMPLATE_URL,
        ...
        '  <input id="{{id}}_value" name="{{inputName}}" tabindex="{{fieldTabindex}}" ng-class="{\'angucomplete-input-not-empty\': notEmpty}" ng-model="searchStr" ng-disabled="disableInput" type="{{inputType}}" placeholder="{{placeholder}}" maxlength="{{maxlength}}" ng-focus="onFocusHandler()" class="{{inputClass}}" ng-focus="resetHideResults()" ng-blur="blurExternalFunction();hideResults($event);updateValidityOnBlur()" autocapitalize="off" autocorrect="off" autocomplete="off" ng-change="inputChangeHandler(searchStr)"/>' + // Line added
    ...
    function link(scope, elem, attrs, ctrl) {
      ...
      scope.$watch(function() {return elem.attr('class'); }, function() {
        console.log("ici");
      });

      scope.test = function() {
        console.log("in focus input");
        ctrl[scope.inputName].$setUntouched();
      }

      scope.blurExternalFunction = function() {
        console.log("test");
        ctrl[scope.inputName].$setUntouched();
        if (typeof scope.blurFunction === 'function') {
          scope.blurFunction();
        }
      }
      // Function added
